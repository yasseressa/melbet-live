          ...
          <Card>
            ...
            <div id="today" className="p-4 space-y-3">
              {matches.length === 0 ? (
                ...
                <a
                  key={m.externalId}
                  href={`/${locale}/match/${m.slug}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block overflow-hidden rounded-2xl border border-neutral-800 bg-neutral-950/70 transition hover:bg-neutral-900/80"
                >
                  ...
                  <div className="grid grid-cols-1 gap-2 border-t border-neutral-800 bg-neutral-900/60 px-4 py-3 text-sm text-neutral-200 md:grid-cols-3">
                    <div className="font-semibold text-white">
                      ...
                      <span className="ms-1 text-neutral-400">{locale === "ar" ? "[كأس]" : "[Cup]"}</span>
                    </div>
                  ...
                  <div className="border-t border-neutral-800 bg-neutral-900/60 px-4 py-3">
                    <span className="inline-flex items-center justify-center rounded-xl bg-melbet-yellow px-3 py-2 text-sm font-semibold text-black">
                      {locale === "ar" ? "\u062a\u0641\u0627\u0635\u064a\u0644 \u0627\u0644\u0645\u0628\u0627\u0631\u0627\u0629" : "Match details"}
                    </span>
                  </div>
                </a>
              ))}
